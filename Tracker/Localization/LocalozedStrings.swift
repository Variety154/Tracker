...
enum LocalizedStrings {
    ...
    enum Trackers {
        ...
        static let searchPlaceHolderText = NSLocalizedString("trackers.search_placeholder.text", comment: "Text for the search placeholder")
    ...
    enum Statistics {
        ...
        static let averageValue = NSLocalizedString("statistics.averageValue", comment: "Average value")
    }
